...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{abstract.tex} ist das Abstrakt, immer auf Englisch.
        \item \texttt{zusammenfassung.tex} ist die Zusammenfassung, selber Inhalt wie das Abstrakt, nur auf Deutsch.
...
\begin{itemize}
    ...
    \item auch in der Hauptdatei bei ``Zeiterfassung einbinden'' die Zeiterfassungsdateien von allen Personen angeben
    \item in \verb|abstract.tex| eine Überschrift für jede Person einfügen
    \item in \verb|zusammenfassung.tex| genauso eine Überschrift für jede Person einfügen
...
\begin{itemize}
    ...
    \item Jeder schreibt:
    \begin{itemize}
        \item Seine Zeiterfassung in \verb|zeiterfassung.tex|
        \item Ein Abstrakt von seiner Diplomarbeit in \verb|abstract.tex|, auf Englisch
        \item Das Abstrakt auf Deutsch in \verb|zusammenfassung.tex| (oder Zusammenfassung schreiben und für Abstrakt übersetzen)
...
\begin{itemize}
    ...
    \item Alle Sektionen die mit dem Kommentar ``LÖSCHEN WENN NICHT BENÖTIGT'' markiert sind, löschen oder auskommentieren, dann ist das Tutorial nicht mehr im Dokument.
\end{itemize}
...
\makeatletter
Sollte es Fragen oder Verbesserungsvorschläge an der Vorlage geben, könnt ihr mich unter \href{mailto:christian.patzl@gmx.net}{christian.patzl@gmx.net} anschreiben, erwartet aber nicht, dass ich in einer Woche antworte. Sonst sucht jemanden, der jemanden kennt, der mich noch kennt, oder erstellt ein Issue auf \href{https://github.com/Christiano300/DiplVorlage}{Github}.
\makeatother

Ich hoffe, dass euch die Vorlage hilft, Arbeit erspart und euch zumindest einen kleinen Überblick über die Teile gibt. Wenn ihr selber Verbesserungen macht, könnt ihr mir gerne die Änderungen schicken, oder gebt es selbst an die nächsten Jahrgänge weiter, \#breakgenerationaltrauma.