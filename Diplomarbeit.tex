...
\addcontentsline{toc}{chapter}{Vorwort} % Manuell einen Eintrag ins Inhaltsverzeichnis einfügen
...
\include{textparts/0/1_latex}
\include{textparts/0/2_vorlage}
% END: Tutorial + Erklärung, LÖSCHEN WENN NICHT BENÖTIGT
% Diplomarbeit von Person 1
\part[Titel der ersten Arbeit]
{Titel der ersten Arbeit\\\large von Person 1}
\include{textparts/1/1_introduction}
% Diplomarbeit von Person 2
\part[Titel der zweiten Arbeit]
{Titel der zweiten Arbeit\\\large von Person 2}
...
\begingroup
\enlargethispage{5cm}
\markright{Kapitelzuordnung}
\input{textparts/chapter_assignment}
\cleardoublepage{}
\endgroup

\markright{Dokumentation}
